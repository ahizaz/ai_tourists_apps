...
class HomeSelectPlaceMap extends StatelessWidget {
  ...
  /// Public static method so PlaceDetails can directly open
  /// the AI guide without navigating to this map screen.
  static void showAIGuideBottomSheet(
    BuildContext context,
    Place place,
    HomeController controller,
  ) {
  ...
  static Widget _buildInitialGuideView(
    BuildContext context,
    Place place,
    HomeController controller,
  ) {
