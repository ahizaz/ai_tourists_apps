...
//     // Already selected হলে remove করবে।
//     if (existingIndex != -1) {
...
//     // Controller-এর value-ও normalized রাখবে।
...
//           .saveProfileImageBase64(base64Image);
//     } catch (error) {
//       debugPrint(
...
//     ) {
//       if (qaAnswers[index] ==
//           qaQuestions[index]['correctAnswer']) {
//         correctCount++;
//       }
//     }
...
//       final savedBase64 =
//           storage.getProfileImageBase64();

//       if (savedBase64 != null &&
//           savedBase64.isNotEmpty) {
//         profileImageBytes.value =
//             base64Decode(savedBase64);
//       }
//     } catch (error) {
//       debugPrint(
//         'Error loading profile info: $error',
//       );
//     }
//   }
